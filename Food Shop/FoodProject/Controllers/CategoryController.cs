...
namespace FoodProject.Controllers
{
    public class CategoryController : Controller
    {
        ...
        // GET: CategoryController all categories or search by category name or filter by category name
        [HttpGet]
        ...
        // GET: CategoryController/CategoryAdd
        [HttpGet]
        ...
        // GET: CategoryController/CategoryGet/5 category Details to update
        [HttpGet]
        ...
        // POST: CategoryController/CategoryUpdate update category
        [HttpPost]
        ...
        // GET: CategoryController/CategoryDelete/5 delete category
        [HttpDelete]
