...
namespace FoodProject.Controllers
{
    ...
    public class FoodController : Controller
    {
        ...
        {
            List<SelectListItem> values = (from x in context.Categories.Where(x=>x.Status==true).ToList() select new SelectListItem{ Text = x.CategoryName, Value = x.CategoryID.ToString()}).ToList();
